...
export default function AdminMenu() {
  ...
  return <div>
    <div className="flex flex-wrap items-end justify-between gap-4">
      <div>
        <h1 className="text-3xl font-black">Admin Menu Management</h1>
        <p className="mt-2 text-slate-600">Demo menu controls. Firestore CRUD can replace this local state later.</p>
      </div>
